...
<events>\
<event symbol=\"AuditLogNotice\" value=\"1\" version=\"0\" channel=\"Audit Log\" level=\"Notice\" template=\"AuditLogMessage\" keywords=\"Audit \" message=\"$(string.RethinkDB.event.1.message)\">\
</event>\
<event symbol=\"AuditLogError\" value=\"2\" version=\"0\" channel=\"Audit Log\" level=\"Error\" template=\"AuditLogMessage\" keywords=\"Audit \" message=\"$(string.RethinkDB.event.2.message)\">\
</event>\
<event symbol=\"AuditLogInfo\" value=\"3\" version=\"0\" channel=\"Audit Log\" level=\"Info\" template=\"AuditLogMessage\" keywords=\"Audit \" message=\"$(string.RethinkDB.event.3.message)\">\
</event>\
<event symbol=\"AuditLogWarn\" value=\"4\" version=\"0\" channel=\"Audit Log\" level=\"Warn\" template=\"AuditLogMessage\" keywords=\"Audit \" message=\"$(string.RethinkDB.event.4.message)\">\
</event>\
<event symbol=\"AuditLogCritical\" value=\"5\" version=\"0\" channel=\"Audit Log\" level=\"Critical\" template=\"AuditLogMessage\" keywords=\"Audit \" message=\"$(string.RethinkDB.event.5.message)\">\
</event>\
<event symbol=\"AuditLogAlert\" value=\"6\" version=\"0\" channel=\"Audit Log\" level=\"Alert\" template=\"AuditLogMessage\" keywords=\"Audit \" message=\"$(string.RethinkDB.event.6.message)\">\
</event>\
<event symbol=\"AuditLogEmergency\" value=\"7\" version=\"0\" channel=\"Audit Log\" level=\"Emergency\" template=\"AuditLogMessage\" keywords=\"Audit \" message=\"$(string.RethinkDB.event.7.message)\">\
</event>\
</events>\
<levels>\
...
<channels>\
<channel name=\"Audit Log\" chid=\"Audit Log\" symbol=\"AuditLog\" type=\"Operational\" enabled=\"false\">\
</channel>\
</channels>\
<keywords>\
